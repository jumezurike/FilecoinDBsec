...
/**
 * Created by LokDon, LLC on 06/11/16.
 */
...
public class KnightSolver {
    ...
    public void setPosition(int xx, int yy) {
        this.startX = xx;
        this.startY = yy;
      //  DebugUtil.printLog(" xx : " + xx + "  yy : " + yy + "  start cell index " + (startX + startY * height));
        // Init the cells
...
// Pravesh
...

        {
            ...
            for (int i = 0; i < width * height; i++) {
                ...
                // Read the number of dead ends
//                int numDeadEnds;
//                fileHandle >> numDeadEnds;
//
//                // Load all the dead ends from the file
//                for(int j = 0; j < numDeadEnds; j++)	{
//                    int deadEndIndex;
//                    fileHandle >> deadEndIndex;
//
//                    c.addDeadEnd(board + deadEndIndex);
//                }
...
//        else
//        {
//            DebugUtil.printLog("NO old start position data found from previous runs for start location (");// << startX << "," << startY << ")" << std::endl;
//        }
...
// Pravesh
        //DebugUtil.printLog("Starting calculations");
