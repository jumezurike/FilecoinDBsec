...
/**
 * Created by LokDon, LLC on 13/11/16.
 */

public class AllCharacter {

    private int CHARSET_SIZE = 256 ;
    public static AllCharacter instance = null;
    private char[] reverseArray =  new char[CHARSET_SIZE];
    private char [] charArray =  new char[CHARSET_SIZE];
...
//            reverseArray = new char[charArray.length];
//            for (int i = 0; i < reverseArray.length; i++) {
//                reverseArray[i] = new char();
//            }
            int index = 0;
